    ...
    <div className="overflow-y-auto">
      ...
      >
        ...
        <div
          ...
          style={{
            background: `
              linear-gradient(to right, hsl(var(--background)) 0%, transparent 7%, transparent 93%, hsl(var(--background)) 100%),
              linear-gradient(to bottom, hsl(var(--background)) 0%, transparent 7%, transparent 93%, hsl(var(--background)) 100%)
            `,
          }}
        />
